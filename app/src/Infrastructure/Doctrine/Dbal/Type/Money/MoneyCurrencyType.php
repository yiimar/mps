...
namespace App\Infrastructure\Doctrine\Dbal\Type\Money;

use App\Infrastructure\Doctrine\Dbal\ValueObject\Money\BaseMoneyCurrency;
use Doctrine\DBAL\Platforms\AbstractPlatform;
use Doctrine\DBAL\Types\StringType;
use function is_string;

final class MoneyCurrencyType extends StringType
{
