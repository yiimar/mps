...
use App\Infrastructure\Http\Message\Stream\StreamFactory;
...
class ServerResponse extends Message implements ResponseInterface
{
     ...
     */
    protected function filterReasonPhrase(mixed $reasonPhrase = ''): string
    {
        ...
        if (str_contains($reasonPhrase, "\r") || str_contains($reasonPhrase, "\n")) {
